namespace Bakery.Models
{
  public class Dialogue
  {
    ...
    Would you like to buy any BREAD? Enter a number of loaves to purchase, or enter 0 to decline.
    ";

        public static string NavPrompt = @"
    Enter 'bread' to purchase additional bread. Enter 'pastry' to purchase additional pastry.  Enter 'order' to display your current order. Enter 'restart' to start your order all over again. Enter 'about' to learn about Pierre's Bakery. Or, enter 'checkout' to check out and start chowing down on that delicious bread.
    ";

    public static string PastriesText = @"
    We also have PASTRIES available. As ALAIN BREMOND-TORRENT once wrote:

    'The softest pain on earth must be the pain au chocolat.'

    Would you like to buy any PASTRIES? Enter a number of treats to purchase, or enter 0 to decline.
    ";
